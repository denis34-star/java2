...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            try {
                System.out.println("Welcome to Client side" + "Connecting to the server\t" + "(IP address" + localhost + ", port" + serverPort + ")");
                ...
                // Ждем ответа от сервера
                    ...
                    if (line.endsWith("quit"))
                        ...
                        System.out.println("The server me this line : \t" + line);
                    }
